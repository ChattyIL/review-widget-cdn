...
/* Purchases: image LEFT, text RIGHT; stable with grid-areas */
+ '.row-p{display:grid;grid-template-columns:112px 1fr;grid-template-areas:"media text";gap:14px;align-items:start;padding:14px 14px 6px;direction:ltr;}'
